...
def num_of_players(df):
    ...
    plt.plot(num_of_players_E.index, num_of_players_E.values, marker='o', markersize=5,
             label="Early Tournament", color='blue', figure=plt.figure(figsize=(12, 6)))
...
def winners_by_starting_rank(df):
    ...
    plt.bar(category_counts.index, category_percents, color='royalblue', edgecolor='black',
            alpha=0.8, figure=plt.figure(figsize=(8, 8)))
